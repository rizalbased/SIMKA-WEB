...
export const DEFAULT_HEADER_THEME: HeaderThemeConfig = {
  ...
  brandBg: '#003B5C',
  brandText: 'SIMKA',
  centerTitle: 'PUSAT INFORMASI DIGITAL',
  logoEnabled: false,
  logoPath: null,
  logoWidth: 105,
  logoHeight: 42,
...
export const settingsService = {
    ...
    try {
      ...
      if (data && data.config) {
        ...
        return {
          ...
          brandText: c.brandText || c.brand || '#FFFFFF',
          centerTitle: c.centerTitle || '',
          logoEnabled: c.logoEnabled || false,
          logoPath: c.logoPath || null,
          logoWidth: c.logoWidth || 105,
          logoHeight: c.logoHeight || 42,
  ...
  async saveHeaderTheme(theme: HeaderThemeConfig) {
    const payload = {
      ...
      brandText: theme.brandText || theme.brand || '#FFFFFF',
      centerTitle: theme.centerTitle || '',
      logoEnabled: theme.logoEnabled || false,
      logoPath: theme.logoPath || null,
      logoWidth: theme.logoWidth || 105,
      logoHeight: theme.logoHeight || 42,
