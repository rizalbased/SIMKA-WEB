...
export const INITIAL_MEDIA_LIBRARY: MediaItem[] = [
  {
    id: 'med-f1',
    title: 'Diskusi Kelas Interaktif Siswa',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[0],
    category: 'Pembelajaran',
    dimensions: '1000 × 1500 (Portrait)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-f2',
    title: 'Suasana Belajar Laboratorium',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[1],
    category: 'Pembelajaran',
    dimensions: '1000 × 1500 (Portrait)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-f3',
    title: 'Presentasi Proyek Sains Kelompok',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[2],
    category: 'Pembelajaran',
    dimensions: '1000 × 1500 (Portrait)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-f4',
    title: 'Praktikum Komputer & Coding',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[3],
  ...
  {
    id: 'med-f5',
    title: 'Eksperimen Mikroskop Biologi',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[4],
    category: 'Laboratorium',
    dimensions: '1000 × 1500 (Portrait)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-f6',
    title: 'Klinik Guru & Bimbingan Belajar',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[5],
    category: 'Laboratorium',
    dimensions: '1000 × 1500 (Portrait)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-f7',
    title: 'Latihan Musik & Band Sekolah',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[6],
  ...
  {
    id: 'med-f8',
    title: 'Tim Basket & Olahraga Prestasi',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[7],
    category: 'Ekstrakurikuler',
    dimensions: '1000 × 1500 (Portrait)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-f9',
    title: 'Kegiatan Pramuka & Kepemimpinan',
    type: 'foto',
    url: INITIAL_PRESET_PHOTOS[8],
    category: 'Ekstrakurikuler',
    dimensions: '1000 × 1500 (Portrait)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-v1',
    title: 'Video Kegiatan Siswa & MPLS.mp4',
    type: 'video',
    url: INITIAL_PRESET_VIDEOS[0].videoUrl,
    category: 'Kegiatan',
  ...
  {
    id: 'med-v2',
    title: 'Video Inovasi Robotika STEM.mp4',
    type: 'video',
    url: INITIAL_PRESET_VIDEOS[1].videoUrl,
    category: 'Sains',
    dimensions: '1920 × 1080 Full HD',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-p1',
    title: 'Poster Jadwal Ujian Semester',
    type: 'poster',
    url: INITIAL_PRESET_POSTERS[0].imageUrl,
    category: 'Akademik',
    dimensions: '1080 × 1920 (Poster)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-p2',
    title: 'Poster Juara Robotika Nasional',
    type: 'poster',
    url: INITIAL_PRESET_POSTERS[1].imageUrl,
    category: 'Prestasi',
    dimensions: '1080 × 1920 (Poster)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-p3',
    title: 'Poster Pendaftaran Ekskul & Club',
    type: 'poster',
    url: INITIAL_PRESET_POSTERS[2].imageUrl,
    category: 'Kegiatan',
    dimensions: '1080 × 1920 (Poster)',
    dateAdded: '28 Agu 2026'
  },
  {
    id: 'med-p4',
    title: 'Poster Brosur Resmi SPMB 2026',
    type: 'poster',
    url: INITIAL_PRESET_POSTERS[3].imageUrl,
    category: 'Pengumuman',
    dimensions: '1080 × 1920 (Poster)',
    dateAdded: '28 Agu 2026'
  }
